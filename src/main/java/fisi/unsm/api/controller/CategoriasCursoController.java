...
public class CategoriasCursoController {
    ...
    public CategoriasCurso guardar(@RequestBody CategoriasCurso categoriasCurso) {
        serviceCategoriasCurso.guardar(categoriasCurso);
        return categoriasCurso;
    }
    @PutMapping("/categoriascurso")
    public CategoriasCurso modificar(@RequestBody CategoriasCurso categoriasCurso) {
        serviceCategoriasCurso.modificar(categoriasCurso);
        return categoriasCurso;
    }
