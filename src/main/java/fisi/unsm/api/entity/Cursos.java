...
public class Cursos {
    ...
    @JsonIgnoreProperties({"hibernateLazyInitializer", "handler"})
    private NaturalezasCursos id_naturaleza;
    ...
    public TiposCursos getId_tipo() {
        return id_tipo;
    }

    public void setId_tipo(TiposCursos id_tipo) {
    ...
    public NaturalezasCursos getId_naturaleza() {
        return id_naturaleza;
    }

    public void setId_naturaleza(NaturalezasCursos id_naturaleza) {
