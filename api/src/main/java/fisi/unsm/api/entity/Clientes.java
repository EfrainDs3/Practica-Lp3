...
public class Clientes {
    ...
    public String toString() {
        return "Clientes [id=" + id + ", nombre=" + nombre + ", correo=" + correo + ", zip=" + zip + ", telefono1="
                ...
                + estado + ", getId()=" + getId() + ", getNombre()=" + getNombre() + ", getCorreo()=" + getCorreo()
                + ", getZip()=" + getZip() + ", getTelefono1()=" + getTelefono1() + ", getTelefono2()=" + getTelefono2()
                + ", getPais()=" + getPais() + ", getDireccion()=" + getDireccion() + ", getEstado()=" + getEstado()
